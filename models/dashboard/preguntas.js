...
export class Preguntas extends IDash{
    ...
    Start(){
        ...
        this.pag_dash.innerHTML = `
            <div class="title_container_dash">
                <h3 class="title_text_dash">Escucha Activa y Preguntas de Seguimiento</h3>
                <h5 class="commentary">Chat with SOFIA</h5>
            </div>
            <div class="module_container_dash">
                <div class="calification_container_data">
                    <h2 class="cal_title">${this.main.preguntas}</h2>
                    <h3>Calificación</h3>
        ...
        document.querySelector('.calification_change_btn').addEventListener('click', async()=>{
            ...
            try {
                ...
                await this.CombinedPostData('preguntas_calification', 'preguntas_base_chat');
    ...
    async GetData(){
        ...
        //  Actualizamos el DOM
        this.main.preguntas = data.calificacion;
