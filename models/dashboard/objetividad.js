...
export class Objetividad extends IDash{
    ...
    Start(){
        ...
        document.querySelector('.calification_change_btn').addEventListener('click', async()=>{
            ...
            try {
                ...
                await this.CombinedPostData('objetividad_calification', 'objetividad_base_chat');
    ...
    async GetData(){
        ...
        //  Actualizamos el DOM
        this.main.objetividad = data.calificacion;
