...
export class Structure extends IDash{
    ...
    Start(){
        ...
        document.querySelector('.calification_change_btn').addEventListener('click', async()=>{
            ...
            try {
                ...
                await this.CombinedPostData('structure_calification', 'structure_base_chat');
    ...
    async GetData(){
        ...
        //  Actualizamos el DOM
        this.main.estructura = data.calificacion;
