...
export class Feedback extends IDash{
    ...
    Start(){
        ...
        document.querySelector('.calification_change_btn').addEventListener('click', async()=>{
            ...
            try {
                ...
                await this.CombinedPostData('feedback_calification', 'feedback_base_chat');
    ...
    async GetData(){
        ...
        //  Actualizamos el DOM
        this.main.feedback = data.calificacion;
