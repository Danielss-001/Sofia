...
export class Test extends IDash{
    ...
    Start(){
        ...
        document.querySelector('.calification_change_btn').addEventListener('click', async()=>{
            ...
            try {
                ...
                await this.CombinedPostData('test_calification', 'test_chat');
    ...
    async GetData(){
        ...
        //  Actualizamos el DOM
        this.main.total = data.calificacion;
